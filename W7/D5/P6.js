...
const userToken = jwt.sign({
    userId:101,role:"user",email:"e2e.com"},secretKey,{expiresIn:"1h"}
);
const managerToken = jwt.sign({
    userId:102,role:"manager",email:"m2e.com"},secretKey,{expiresIn:"1h"}
);
const adminToken = jwt.sign({
    userId:103,role:"admin",email:"a2e.com"},secretKey,{expiresIn:"1h"}
);
